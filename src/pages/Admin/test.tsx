                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    {customer.type && <span className="px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm font-medium">{customer.type}</span>}
                                </div>
                            </div>
                        </section>
                                ...
                                <div className="bg-yellow-50 p-4 rounded-lg">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-lg font-semibold text-yellow-600">{parseInt(customer.branch.reduce((total: number, b: any) => total + b.gold, 0).toString())}g</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <section>
                            ...
                            <div className="flex space-x-4">
                                {customer.document?.url && (
                                    <div
                                        className="flex items-center space-x-2 bg-gray-50 p-3 rounded-lg cursor-pointer hover:bg-gray-100"
                                        onClick={() => window.open(customer.document.url, '_blank')}
                                        title="Click to view document"
                                    >
                                        <FileText className="h-5 w-5 text-gray-600" />
                                        <span className="text-sm underline">Document side one</span>
                                    </div>
                                )}
                                ...
                                {customer.documentFront?.url && (
                                    <div
                                        className="flex items-center space-x-2 bg-gray-50 p-3 rounded-lg cursor-pointer hover:bg-gray-100"
                                        onClick={() => window.open(customer.documentFront.url, '_blank')}
                                        title="Click to view document"
                                    >
                                        <FileText className="h-5 w-5 text-gray-600" />
                                        <span className="text-sm underline">Document side two</span>
                                    </div>
                                )}
                            </div>
                        </section>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-green-600">{customers.filter((c) => c.kycStatus === 'approved').length}</p>
                            </div>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-yellow-600">{customers.filter((c) => c.kycStatus === 'pending').length}</p>
                            </div>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-blue-600">{formatCurrency(customers.reduce((sum, c) => sum + c.cash, 0))}</p>
                            </div>
                            <div className="h-12 w-12 bg-blue-100 rounded-full flex items-center justify-center">
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Gold Holdings</th>
                                ...
                                {filteredCustomers.map((customer) => (
                                    <tr key={customer._id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            ...
                                            {customer.type && (
                                                <div className="mt-1">
                                                    <span className="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-purple-100 text-purple-800">{customer.type}</span>
                                                </div>
                                            )}
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{formatCurrency(customer.cash)}</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            {parseInt(customer.branch.reduce((total: number, b: any) => total + b.gold, 0).toString())}g
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div className="flex space-x-2">
                                                <button onClick={() => handleViewCustomer(customer)} className="text-blue-600 hover:text-blue-900 flex items-center space-x-1">
