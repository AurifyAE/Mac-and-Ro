...
const BranchAdmin = lazy(() => import('../pages/SuperAdmin/BranchAdmin'));
const Branches = lazy(() => import('../pages/SuperAdmin/Branches'));
const BranchCharges = lazy(() => import('../pages/SuperAdmin/BranchCharges'));
...
const getRoleBasedRoutes = () => {
    ...
    // fallback: public routes (like login)
    return [
        {
...
export { routes, adminRoutes, superAdminRoutes, getRoleBasedRoutes };