        ...
        <header className={`z-40 ${themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''}`}>
            <div className="shadow-sm">
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    {/* Desktop Sidebar Toggle Button - Hidden when sidebar is expanded */}
                    <button
                        type="button"
                        className={`collapse-icon flex-none dark:text-[#d0d2d6] hover:text-primary dark:hover:text-primary ltr:mr-2 rtl:ml-2 p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:bg-white-light/90 dark:hover:bg-dark/60 ${
                            themeConfig.sidebar ? 'hidden' : 'flex'
                        }`}
                        onClick={() => {
